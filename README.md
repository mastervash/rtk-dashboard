...
> All screenshots use synthetic data — `scripts/seed-demo.mjs` for the history
> database and `scripts/fake-rtk.mjs` standing in for the rtk binary. No real
> paths, projects, or commands appear in any of them.
...
`seed-demo.mjs` generates ~1,900 fake commands across six fictional projects
